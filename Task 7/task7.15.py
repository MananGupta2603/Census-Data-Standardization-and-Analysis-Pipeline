...
#-------------------------------------
mycursor.execute("SELECT State_UT,Type_of_latrine_facility_Pit_latrine_Households,Type_of_latrine_facility_Other_latrine_Households,TypeoflatrinefacilityNightsoildisposedintoopendrainHouseholds As Type_of_latrine_facility_Night_soil_disposed_into_open_drain_Households,T_LatrineFac_FP_ConOtherSys_HH As Type_of_latrine_facility_Flush_pour_flush_latrine_connected_to_other_system_Households FROM census_db.census Group By state_ut")
